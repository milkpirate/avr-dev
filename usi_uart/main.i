...
int main( void )
{
    while(1)
    {
  usi_uart_tx_str_P((__extension__({static const char __c[] __attribute__((__progmem__)) = ("\n\rHello you there!"); &__c[0];})));
  _delay_ms(250);
    }
  return 0;
}
