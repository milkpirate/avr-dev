...
////////////////////////////////////////////////////////////////////////////////
// Setzt den Cursor in Spalte x (0..15) Zeile y (0..1)

void lcd_setcursor( uint8_t x, uint8_t y )
{
    lcd_command(LCD_SET_DDADR+y*LCD_DDADR_LINE2+x);
}
...
////////////////////////////////////////////////////////////////////////////////
// Schreibt einen progmem Strings auf das LCD

void lcd_string_P(const char str[])
{
    while(pgm_read_byte(str))	lcd_data(pgm_read_byte(str++));
}
...
////////////////////////////////////////////////////////////////////////////////
// Schreibt ein progmem Zeichen in den Character Generator RAM
...
void lcd_generatechar_P( uint8_t code, const uint8_t data[])
{
    ...
    lcd_command( LCD_SET_CGADR | (code<<3) );
    // Bitmuster übertragen
    for ( uint8_t i=0; i<8; i++ )	lcd_data(pgm_read_byte(data++));
}
